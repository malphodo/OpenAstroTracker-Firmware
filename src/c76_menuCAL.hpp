...
enum
{
    ...
    HIGHLIGHT_LAST = HIGHLIGHT_BACKLIGHT
        ...
        #define UTC_OFFSET_CALIBRATION 94
...
void gotoNextHighlightState(int dir)
{
    ...
    {
        UTCOffset = mount.getLocalUtcOffset();
    }
}
            ...
            case HIGHLIGHT_POLAR:
                {
                    ...
                    else if (key == btnSELECT)
                    {
                        ...
                        mount.targetDEC() = Declination(88 - (inNorthernHemisphere ? 90 : -90), 42, 11);
            ...
            case POLAR_CALIBRATION_WAIT_CENTER_POLARIS:
                {
                    if (key == btnSELECT)
                    {
                        ...
                        mount.syncPosition(mount.currentRA(), Declination(89 - (inNorthernHemisphere ? 90 : -90), 21, 6));
            ...
            case HIGHLIGHT_UTC_OFFSET:
                {
                    ...
                    {
                        calState       = UTC_OFFSET_CALIBRATION;
                        okToUpdateMenu = false;
                    }
                    else if (key == btnRIGHT)
                    {
